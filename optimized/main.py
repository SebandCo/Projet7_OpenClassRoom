...
# with open('dataset2.csv', mode='r', encoding='utf-8') as fichier_csv:
...
print(f"\nLe meilleur montage possible a été trouvé\n"
      f"Le benefice attendu est de {resultat.benefice:.2f} euros\n"
      f"Pour un investissement de départ de {resultat.montant:.2f} euros\n\n"
