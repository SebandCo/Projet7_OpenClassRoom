...
f = 1
actions = {}  # Créez un dictionnaire pour stocker les actions
action_name = "action{}".format(f)
actions[action_name] = "Test"

# Pour accéder à la valeur, utilisez la clé du dictionnaire
print(actions[action_name])  # Affiche "Test"
